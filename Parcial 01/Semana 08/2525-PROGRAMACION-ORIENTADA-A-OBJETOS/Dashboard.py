...
Estudiante: Mery Luje
Semana 8: - Programación Orientada a Objetos
Descripción: Dashboard personalizado para la organización,
visualización y ejecución de scripts del curso de POO.
"""
...
# Muestra el menú principal y permite navegar por las unidades del curso
def mostrar_menu():
    ...
    while True:
        print("\nMenu Principal - Dashboard de Mery Luje (POO)")
